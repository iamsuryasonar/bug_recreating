          ...
          {gallery.map((item, index) => {
            return (
              <div key={item.id} className='relative w-full h-full grid mb-4 rounded-lg'>
                ...
                <div className='absolute top-0 left-0 right-0 bottom-0 grid bg-black opacity-0 hover:opacity-65 transition-opacity duration-300'>
                  <div className='grid p-6 place-self-center'>
